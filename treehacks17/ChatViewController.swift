...
class ChatViewController: JSQMessagesViewController {
    ...
    required init?(coder aDecoder: NSCoder) {
        ...
        senderId = User.Wozniak.rawValue
        senderDisplayName = getName(.Wozniak)
    ...
    override func viewDidLoad() {
        ...
        navigationBarAppearace.titleTextAttributes = [NSForegroundColorAttributeName : UIColor(red:0.10, green:0.73, blue:0.76, alpha:1.0)]
        
        //Bubble settings
        // Bubbles with tails
        incomingBubble = JSQMessagesBubbleImageFactory().incomingMessagesBubbleImage(with: UIColor(red:0.10, green:0.73, blue:0.76, alpha:1.0)) //jsq_messageBubbleBlue()
